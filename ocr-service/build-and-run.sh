...
# Build and Run Script for OCR Service
# This script builds the Docker container and runs the OCR service
...
EOF
        print_warning "Please update .env file with your actual GOOGLE_API_KEY"
        return 1
    fi
...
main() {
    echo "=========================================="
    echo "  OCR Service - Build & Run Script"
    echo "=========================================="
    echo ""
    ...
    if ! check_env_file; then
        print_error "Please configure .env file with GOOGLE_API_KEY before running this script"
        exit 1
    fi
    ...
    print_success "OCR service is up and running!"
