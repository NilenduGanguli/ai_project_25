...
SERVICE_NAME="csv-ai-final"
CONTAINER_NAME="csv-analysis-streamlit"
IMAGE_NAME="csv-analysis-agent"
PORT=8501
NETWORK="citi-intern-network"

echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  CSV Analysis Agent Build & Run${NC}"
echo -e "${BLUE}========================================${NC}\n"
...
echo -e "  📊 Upload CSV files for analysis"
echo -e "  💬 Chat with your data using AI"
echo -e "  📈 Generate visualizations (histograms, scatter, bar, box, heatmap)"
echo -e "  🐍 Execute custom pandas code"
echo -e "  📋 Get data summaries and statistics"
echo ""
...
echo -e "${GREEN}✓ CSV Analysis Agent is ready!${NC}"
