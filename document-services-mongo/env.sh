#!/bin/bash
# Environment variables for document services (classification + extraction) with MongoDB
...
export MONGODB_URL="${MONGODB_URL:-mongodb://admin:password123@mongodb:27017}"
